...
alerts.infrastructureConditions.create = function(configId, policyId, cond, cb) {
  var url = urls.api.alertsInfrastructureConditions.create.replace('{policy_id}',policyId)
...
alerts.infrastructureConditions.update = function(configId, condId, cond, cb) {
  var url = urls.api.alertsInfrastructureConditions.updateDelete.replace('{condition_id}',condId)
