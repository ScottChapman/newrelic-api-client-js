...
alerts.syntheticsConditions.create = function(configId, policyId, cond, cb) {
  var url = urls.api.alertsSyntheticsConditions.create.replace('{policy_id}',policyId);
  helper.sendPutOrPostBody(url, 'POST', cond, configId, 'adminKey', cb);
}
...
alerts.channels.delete = function(configId, id, cb) {
