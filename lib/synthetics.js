...
synthetics.updateMonitor = function updateMonitor(monitorBody, configId, cb) {
  var url = urls.synthetics.monitors.monitor.replace('{monitor_id}', monitor.id);
  helper.sendPutOrPostBody(url, 'PUT', monitorBody, configId, 'adminKey', cb);
}
